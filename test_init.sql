...
-- Campo ID es autoincremental


-- Inserta un usuario admin solo si no hay conflicto
...
-- Crea usuario 'tuser' (test user) para correr tests con selenium, Solo si no hay conflicto
INSERT INTO users (username, hash)
